    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "https://www.facebook.com/cyhermes",
                TwitterLink = "https://twitter.com/cyhermes",
                YoutubeLink = "https://www.youtube.com/user/cyhermes",
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "About cyCommerce",
                    Short = "It's stable and highly usable. From downloads to documentation, www.cyhermes.com offers a comprehensive base of information, resources, and support to the cyCommerce community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.cyhermes.com\">cyhermes.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "cyCommerce new release!",
                    Short = "cyCommerce includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! cyCommerce is a fully customizable shopping cart",
                    Full = "<p>cyCommerce includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new cyCommerce store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
